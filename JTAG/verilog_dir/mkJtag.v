...
//
// On Fri Jun 23 14:36:20 IST 2017
//
//
// Ports:
// Name                         I/O  size props
...
module mkJtag(CLK,
  ...
  // register command_select
  reg command_select;
  wire command_select$D_IN, command_select$EN;

  // register command_tdo
  reg command_tdo;
  wire command_tdo$D_IN, command_tdo$EN;
  ...
  // register latch_command
  reg [31 : 0] latch_command;
  wire [31 : 0] latch_command$D_IN;
  wire latch_command$EN;

  // register latch_dba
  reg [3 : 0] latch_dba;
  wire [3 : 0] latch_dba$D_IN;
  wire latch_dba$EN;
  ...
  wire CAN_FIRE_RL_cross_bypass_clock_domain_crossing,
       CAN_FIRE_RL_cross_command_clock_domain_crossing,
       ...
       CAN_FIRE_RL_cross_latch_command_clock_domain_crossing,
       ...
       CAN_FIRE_RL_rl_print_state1,
       CAN_FIRE_RL_rl_print_state2,
       ...
       WILL_FIRE_RL_cross_command_clock_domain_crossing,
       ...
       WILL_FIRE_RL_cross_latch_command_clock_domain_crossing,
       ...
       WILL_FIRE_RL_rl_print_state1,
       WILL_FIRE_RL_rl_print_state2,
  ...
  wire [31 : 0] temp_command___1__h7327,
		temp_dtm___1__h7563,
		temp_idcode___1__h7740;
  wire [4 : 0] temp___1__h7134;
  wire [3 : 0] temp_dba___1__h7448;
  ...
  // rule RL_rl_print_state1
  assign CAN_FIRE_RL_rl_print_state1 = 1'd1 ;
  assign WILL_FIRE_RL_rl_print_state1 = 1'd1 ;
  ...
  // rule RL_rl_print_state2
  assign CAN_FIRE_RL_rl_print_state2 = 1'd1 ;
  assign WILL_FIRE_RL_rl_print_state2 = 1'd1 ;

  // rule RL_rl_stop
  assign CAN_FIRE_RL_rl_stop = count_tms == 5'd20 ;
  ...
  // rule RL_rl_tp
  assign CAN_FIRE_RL_rl_tp = count_tms < 5'd20 ;
  ...
  assign CAN_FIRE_RL_rl_assign_op = 1'd1 ;
  assign WILL_FIRE_RL_rl_assign_op = 1'd1 ;
  ...
  // rule RL_cross_latch_command_clock_domain_crossing
  assign CAN_FIRE_RL_cross_latch_command_clock_domain_crossing = 1'd1 ;
  assign WILL_FIRE_RL_cross_latch_command_clock_domain_crossing = 1'd1 ;
  ...
  // rule RL_cross_command_clock_domain_crossing
  assign CAN_FIRE_RL_cross_command_clock_domain_crossing = 1'd1 ;
  assign WILL_FIRE_RL_cross_command_clock_domain_crossing = 1'd1 ;
  ...
  assign command$D_IN =
	     shift_dr ?
	       temp_command___1__h7327 :
	       (capture_dr ? latch_command : 32'd0) ;
  assign command$EN =
	     (test_logic_reset || capture_dr || shift_dr) &&
	     latch_ir == 5'd18 ;

  // register command_select
  assign command_select$D_IN = 1'b0 ;
  assign command_select$EN = 1'b0 ;

  // register command_tdo
  assign command_tdo$D_IN = command[0] ;
  assign command_tdo$EN = 1'd1 ;
  ...
  assign instruction$D_IN =
	     shift_ir ? temp___1__h7134 : (capture_ir ? 5'b10101 : 5'd0) ;
  ...
  // register latch_command
  assign latch_command$D_IN = command ;
  assign latch_command$EN = update_dr && latch_ir == 5'd18 ;
  ...
  // register tdi
  assign tdi$D_IN = tdi_vec[count_tdi[2:0]] ;
  assign tdi$EN = shift_dr || shift_ir ;

  // register tdi_vec
  assign tdi_vec$D_IN = 8'h0 ;
  assign tdi_vec$EN = 1'b0 ;

  // register tdo
  always@(latch_ir or
	  bypass_tdo or
	  idcode_tdo or dtm_control_tdo or dba_tdo or command_tdo)
  begin
    case (latch_ir)
      5'd1: tdo$D_IN = idcode_tdo;
      5'd16: tdo$D_IN = dtm_control_tdo;
      5'd17: tdo$D_IN = dba_tdo;
      5'd18: tdo$D_IN = command_tdo;
  ...
  // register tdo_enable
  assign tdo_enable$D_IN = 1'd1 ;
  assign tdo_enable$EN = update_dr ;
  ...
  // remaining internal signals
  assign temp___1__h7134 = { tdi, instruction[4:1] } ;
  assign temp_command___1__h7327 = { tdi, command[31:1] } ;
  assign temp_dba___1__h7448 = { tdi, dba[3:1] } ;
  assign temp_dtm___1__h7563 = { tdi, dtm_control[31:1] } ;
  assign temp_idcode___1__h7740 = { tdi, idcode[31:1] } ;
  ...
  begin
	...
	tdi_vec <= `BSV_ASSIGNMENT_DELAY 8'b10111000;
	test_logic_reset <= `BSV_ASSIGNMENT_DELAY 1'd1;
	tms_vec <= `BSV_ASSIGNMENT_DELAY 20'b01100000111000000110;
	...
	if (command_select$EN)
	  command_select <= `BSV_ASSIGNMENT_DELAY command_select$D_IN;
  ...
  begin
    ...
    if (command_tdo$EN) command_tdo <= `BSV_ASSIGNMENT_DELAY command_tdo$D_IN;
    ...
    if (latch_command$EN)
      latch_command <= `BSV_ASSIGNMENT_DELAY latch_command$D_IN;
  ...
  begin
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 37: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_2] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 48: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_3] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 59: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_4] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 70: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_5] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 81: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_6] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 103: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_8] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 92: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_7] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 114: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_9] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 125: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_10] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 137: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_11] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 149: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_12] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$display("Error: \"../JTAG/src_BSV/Jtag.bsv\", line 116, column 161: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_rl_state_13] and\n  [RL_rl_state_16] ) fired in the same clock cycle.\n");
    if (RST_N != `BSV_RESET_VALUE)
  ...
  // synopsys translate_off
  always@(negedge inverted$CLK_OUT)
  begin
    #0;
    $display("%d %d %d %d %d",
	     instr_tdo,
